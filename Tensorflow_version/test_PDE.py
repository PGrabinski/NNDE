...
ts.train(X=samples, diff_loss=diff_loss, epochs=100000, message_frequency=100, optimizer_name='Adam', learning_rate=0.1)
...
pred = ts(samples)
# print(pred)
Ze5sol = tf.reshape(pred, shape=(samples.shape[0], 1)).numpy()
